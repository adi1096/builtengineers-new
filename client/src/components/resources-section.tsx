...
import { Calculator, CheckCircle, ChartGantt, FileText, Shield, Cloud } from "lucide-react";

interface ResourcesSectionProps {
  onShowBuiltSuite: () => void;
}

export default function ResourcesSection({ onShowBuiltSuite }: ResourcesSectionProps) {
  const features = [
    {
      icon: Calculator,
  ...
  return (
    <section id="resources" className="py-20 bg-gray-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="bg-white rounded-2xl shadow-sm mb-12">
          <CardContent className="p-8 md:p-12 text-center">
            ...
            <p className="text-lg text-gray-text mb-8 max-w-3xl mx-auto">
              Our comprehensive structural engineering software suite provides advanced calculation tools, 
              design verification, and project management capabilities to streamline your engineering workflow.
            </p>
            <Button 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {features.map((feature, index) => {
            ...
            return (
              <Card key={index} className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-200">
